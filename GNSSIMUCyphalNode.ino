/**
 * GNSS and IMU Cyphal Node, based on the CyphalPicoBase-CAN (https://github.com/generationmake/CyphalPicoBase-CAN)
 *
...
void setup()
{
  ...
  (
    ...
    "generationmake.GNSSIMUCyphalNode"
  );
...
//  CanardFilter const CAN_FILTER_EM_STOP = canardMakeFilterForSubject(port_id_em_stop);
  ...
  CanardFilter consolidated_filter = canardConsolidateFilters(&CAN_FILTER_LED, &CAN_FILTER_LED);
